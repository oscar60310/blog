...
![](./jaxx-download-page.png)

<figcaption>Jaxx Liberty 網站，圖片來自 Jaxx 官網。</figcaption>
</figure>
...
<figcaption>假冒的應用程式，圖片來自 Google Play</figcaption>
</figure>
...
<figcaption>Reddit 搜尋結果，圖片來自 Reddit web 截圖</figcaption>
</figure>
