...
tags: ["入門", "長篇", "程式", "typescript"]
slug: 2019/06/16/typescript
authors: ivan
---
...
async function getBooksData(): Promise<void> {
  ...
  if (apiResponse.status === 200) {
    ...
    data.list
      .slice(0, 10)
      .forEach((book) => document.write(book.name + "<br>"));
  }
}
...
至於沒有定義檔的專案呢? [https://aka.ms/types](https://aka.ms/types) 收集了很多 Library 的 type 定義
